...
public class UDPClient extends Thread {
	...
	configuration.REQUEST_TYPE requestType;
	...
	public UDPClient(String serverAddress, int udpPort, byte[] data, configuration.REQUEST_TYPE requestType,ArrayList<PassengerWrapperVO> serverResponse) {
