...
/*
 * @author: VarunPattiah
 * Purpose: Elect the leader among the three replica
 * 
 */
public class LeaderElection extends Thread{
	...
	private void notifyActiveReplicas(int process) {
		new MulticastMessageSender().multicastRequest("LE:"+process, Constants.MC_LE_PORT);
		System.out.println("New Group Leader Replica: "+process);
		new DFRSServer().setGroupLeaderProcessID(process);
	}
